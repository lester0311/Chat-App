...
import 'package:chatapp/view/friends/widgets/friends_header.dart';
import 'package:chatapp/view/friends/widgets/friends_list_item.dart';
import 'package:chatapp/view/messages/widgets/messages_screen.dart';
...
import 'package:chatapp/view/register/widgets/register_screen.dart';
import 'package:chatapp/view/utils/constants.dart';
import 'package:chatapp/view/friends/widgets/edit_screen.dart';
import 'package:chatapp/view/widgets/footer.dart';
                      ...
                      Expanded(
                        child: Stack(
                          children: <Widget>[
                            ...
                            IndexedStack(
                              index: editForm ? 0 : 1,
                              children: const [EditScreen(), FriendsList()],
                            ),
                          ],
                        ),
                      ),
